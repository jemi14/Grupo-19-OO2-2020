...
CREATE TABLE `pedido` (
  ...
  CONSTRAINT `FK9tt6uo9va8fccetnxy3jqngde` FOREIGN KEY (`vendedor_id_persona`) REFERENCES `vendedor` (`id_persona`),
  CONSTRAINT `FKcl9gf7hbaosndcvwud8auides` FOREIGN KEY (`local_id`) REFERENCES `local` (`id`),
  CONSTRAINT `FKee9kmfvfpfbidx3ssf0fbg502` FOREIGN KEY (`cliente_id_persona`) REFERENCES `cliente` (`id_persona`),
  CONSTRAINT `FKsoggxhdxr3wnhv3kdkka1nmvy` FOREIGN KEY (`producto_id`) REFERENCES `producto` (`id`)
...
-- Dump completed on 2020-06-18 18:35:32
