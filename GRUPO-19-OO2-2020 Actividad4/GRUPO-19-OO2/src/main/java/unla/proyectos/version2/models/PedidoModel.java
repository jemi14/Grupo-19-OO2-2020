...
public class PedidoModel {
	...
	public String toString() {
		return "PedidoModel [id=" + id + ", producto=" + producto + ", local=" + local + ", cliente=" + cliente
				...
				+ ", pagado=" + pagado + ", entregado=" + entregado + ", tomado=" + tomado + ", descripcion="
				+ descripcion + "]";
	}
	...
	public PedidoModel(long id, ProductoModel producto, LocalModel local, ClienteModel cliente, int cantidad,
			LocalDate fechaPedido, LocalDate fechaEntrega, boolean pagado, boolean entregado, boolean tomado,
			String descripcion) {
		super();
		this.id = id;
		this.producto = producto;
	...
	public PedidoModel(long id, ProductoModel producto, LocalModel local, ClienteModel cliente, int cantidad,
			LocalDate fechaPedido, LocalDate fechaEntrega, boolean pagado, boolean entregado, boolean tomado,
			String descripcion, VendedorModel vendedor) {
		super();
		this.id = id;
		this.producto = producto;
		this.local = local;
