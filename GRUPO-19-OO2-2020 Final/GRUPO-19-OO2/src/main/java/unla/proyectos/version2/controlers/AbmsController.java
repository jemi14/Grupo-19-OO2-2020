...
public class AbmsController {
    ...
    ////////////////////////////////////////////////////////////////////////////
		...
		GerenteModel gerenteModel = gerenteService.findByIdPersona(id);
		
	
		
		mAV.addObject("gerenteModel", gerenteModel );
		...
		VendedorModel vendedorModel =vendedorService.findByIdPersona(id);
		
		System.out.println(vendedorModel);
		
		long idLocal = vendedorModel.getLocal().getId();
		 
		 vendedorModel.setLocal(localService.findById(idLocal));
		
		mAV.addObject("vendedorModel", vendedorModel );
