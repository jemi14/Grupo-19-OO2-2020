...
public class CargaController {
	...
	public RedirectView redirectToHomeIndex() {
		...
		StockModel s7 = new StockModel(productoService.findById(4),localService.findById(1),20,null);
		StockModel s8 = new StockModel(productoService.findById(5),localService.findById(1),102,null);
