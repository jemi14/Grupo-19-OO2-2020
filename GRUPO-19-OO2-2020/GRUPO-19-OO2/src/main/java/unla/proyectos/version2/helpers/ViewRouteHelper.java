...
public class ViewRouteHelper {
	...
	public final static String PEDIDOS_INDEX = "pedidos/index";
	public final static String PEDIDOS_FECHAS = "pedidos/entrefechas";
	public final static String PEDIDOS_FECHAS_SUELDO = "pedidos/entrefechassueldo";
	
	public final static String COMPRAS_INDEX = "compras/index";
	public final static String COMPRAS_UPDATE = "compras/update";
