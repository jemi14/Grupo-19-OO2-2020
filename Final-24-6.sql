CREATE DATABASE  IF NOT EXISTS `grupo-19-bdd-oo2-2020` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `grupo-19-bdd-oo2-2020`;
-- MySQL dump 10.13  Distrib 8.0.19, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: grupo-19-bdd-oo2-2020
-- ------------------------------------------------------
...
CREATE TABLE `local` (
  ...
  `gerente_id_persona` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKckynv5hyopte2cp332egt4a4w` (`gerente_id_persona`),
  CONSTRAINT `FKckynv5hyopte2cp332egt4a4w` FOREIGN KEY (`gerente_id_persona`) REFERENCES `gerente` (`id_persona`) ON DELETE CASCADE ON UPDATE NO ACTION
...
CREATE TABLE `pedido` (
  ...
  `cliente_id_persona` bigint(20) DEFAULT NULL,
  `local_id` bigint(20) DEFAULT NULL,
  `producto_id` bigint(20) DEFAULT NULL,
  `vendedor_id_persona` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `FK9tt6uo9va8fccetnxy3jqngde` FOREIGN KEY (`vendedor_id_persona`) REFERENCES `vendedor` (`id_persona`) ON DELETE CASCADE,
  CONSTRAINT `FKcl9gf7hbaosndcvwud8auides` FOREIGN KEY (`local_id`) REFERENCES `local` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FKee9kmfvfpfbidx3ssf0fbg502` FOREIGN KEY (`cliente_id_persona`) REFERENCES `cliente` (`id_persona`) ON DELETE CASCADE,
  CONSTRAINT `FKsoggxhdxr3wnhv3kdkka1nmvy` FOREIGN KEY (`producto_id`) REFERENCES `producto` (`id`) ON DELETE CASCADE
...
CREATE TABLE `stock` (
  ...
  CONSTRAINT `FK1hx9o107cpb0o8hppaicd7af9` FOREIGN KEY (`producto_id`) REFERENCES `producto` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `FKmteaiv8alkvidnj3rca5r110h` FOREIGN KEY (`local_id`) REFERENCES `local` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
...
CREATE TABLE `vendedor` (
  ...
  CONSTRAINT `FK5p8oeqjy48ubmjngebufdgnk8` FOREIGN KEY (`local_id`) REFERENCES `local` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FKroe98nhopj8kja00hydk444pu` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id_persona`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-06-24 16:25:34
