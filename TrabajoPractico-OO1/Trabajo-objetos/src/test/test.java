...
public class test {
	...
	public static void main(String[] args) {
		...
		try {
			gestor.altaLocal("Av. Pres. Hipólito Yrigoyen 12485", -34.800631f, -58.408077f, 425874697);
		} catch (Exception e) {
			e.printStackTrace();
			// TODO: handle exception
		}
		...
		try {
			gestor.altaProducto("Nike More Uptempo", "Lo último en moda", 14999, LocalDate.of(2019, 10, 3));
		} catch (Exception e) {
			e.printStackTrace();
			// TODO: handle exception
		}
		...
		try {
			System.out.println("Producto 3 existe en algún carrito?: " + gestor.saberSiExisteEnUnCarrito(3));
		} catch (Exception e) {
			e.printStackTrace();
		}
		System.out.println();
		...
		System.out.println("Producto más vendido: " + gestor.productoMasVendidoPorCantidad(gestor.getListaProductos()));
		System.out.println("-------------------------------------------------------------");
		System.out.println();
